...
// --- categorización por INSTRUMENTO (heurística por nombre) ------------------
// abreviaturas de baterías (dough-samples / cajas de ritmo): token exacto → familia.
const ABBR: Record<string, string> = {
  bd: 'kick', kick: 'kick', kik: 'kick', bassdrum: 'kick',
  sd: 'snare', sn: 'snare', snare: 'snare', rim: 'snare', rs: 'snare', rimshot: 'snare', cp: 'snare', clap: 'snare', clp: 'snare',
  hh: 'hat', oh: 'hat', ch: 'hat', sh: 'hat', hat: 'hat', hats: 'hat', hihat: 'hat', shaker: 'hat',
  cr: 'cymbal', rd: 'cymbal', cy: 'cymbal', crash: 'cymbal', ride: 'cymbal', cym: 'cymbal', splash: 'cymbal',
  lt: 'perc', mt: 'perc', ht: 'perc', tom: 'perc', perc: 'perc', misc: 'perc', cb: 'perc', cowbell: 'perc',
  conga: 'perc', bongo: 'perc', clave: 'perc', tabla: 'perc', click: 'perc', tick: 'perc', block: 'perc',
};
const INST_WORDS = ['piano', 'guitar', 'guitarra', 'violin', 'viola', 'cello', 'contrabass', 'flute', 'flauta', 'sax', 'clarinet', 'oboe', 'bassoon', 'organ', 'marimba', 'kalimba', 'vibraphone', 'xylophone', 'glockenspiel', 'harp', 'arpa', 'strings', 'string', 'brass', 'trumpet', 'trompeta', 'horn', 'trombone', 'tuba', 'epiano', 'rhodes', 'wurli', 'celesta', 'accordion', 'accordeon', 'acordeon', 'banjo', 'mandolin', 'koto', 'sitar', 'erhu', 'oud', 'harmonium', 'recorder', 'mallet', 'ukulele', 'steelpan', 'handpan', 'ocarina', 'melodica', 'bell', 'keys', 'flauta', 'cuerda', 'violin'];
const SYNTH_WORDS = ['synth', 'lead', 'stab', 'chord', 'pad', 'arp', 'saw', 'square', 'pluck', 'pluk', 'reese', 'hoover', 'acid', 'blip', 'bleep', 'chip', 'seq', 'poly', 'moog', 'juno', 'perrey', 'teentonic'];
const BASS_WORDS = ['bass', 'bajo', 'sub', 'jvbass', '808bass', 'wobble', '808'];
const VOX_WORDS = ['vox', 'voice', 'vocal', 'speak', 'voz', 'sing', 'choir', 'acapella', 'longvocal', 'ctvox', 'in_'];
const LOOP_WORDS = ['amen', 'break', 'funkydrummer', 'apache', 'think', 'loop', 'drumloop', 'groove', 'beat', 'top'];
const FX_WORDS = ['fx', 'noise', 'wind', 'vinyl', 'riser', 'sweep', 'impact', 'atmos', 'atmosphere', 'space', 'metal', 'glitch', 'zap', 'laser', 'crackle', 'birds', 'insect', 'foley', 'ambient', 'drone', 'texture', 'reverse', 'coffee', 'water', 'rain'];

function instrToken(name: string): string {
...
// percusión exacta (abreviatura) → bajo → instrumento real → sinte → voz → loop → fx.
