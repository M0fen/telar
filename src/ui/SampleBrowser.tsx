...
const PERC_WORDS = ['conga', 'bongo', 'timbale', 'timbal', 'guiro', 'cabasa', 'agogo', 'cowbell', 'clave', 'tumba', 'djembe', 'darbuka', 'tabla', 'surdo', 'cuica', 'maraca', 'tambourine', 'woodblock', 'castanet', 'cajon', 'shaker', 'shekere', 'caxixi', 'ganza', 'pandeiro', 'tamborim', 'bata_', 'timbau'];
...
const TAG_WORDS = ['airhorn', 'air_horn', 'siren', 'rewind', 'pullup', 'pull_up', 'scratch', 'braam', 'downlifter', 'uplifter', 'whoosh', 'tapestop', 'tape_stop', 'shout', 'sub_drop', 'subdrop', 'gunshot'];
...
const SYNTH_WORDS = ['synth', 'lead', 'stab', 'chord', 'pad', 'arp', 'saw', 'square', 'pluck', 'pluk', 'hoover', 'blip', 'bleep', 'chip', 'seq', 'poly', 'moog', 'juno', 'perrey', 'teentonic', 'pwm', 'fmlead', 'wavetable'];
const BASS_WORDS = ['bass', 'bajo', 'sub', 'jvbass', '808bass', 'wobble', '808', 'reese', 'donk', 'acid', '303', 'fmbass', 'subbass', 'bassline', 'moogbass'];
const VOX_WORDS = ['vox', 'voice', 'vocal', 'speak', 'voz', 'sing', 'choir', 'acapella', 'longvocal', 'ctvox', 'in_', 'adlib', 'phrase', 'word', 'chant', 'hey', 'yeah'];
const LOOP_WORDS = ['amen', 'break', 'funkydrummer', 'apache', 'think', 'loop', 'drumloop', 'groove', 'beat', 'top', 'tumbao'];
const FX_WORDS = ['fx', 'noise', 'wind', 'vinyl', 'riser', 'sweep', 'impact', 'atmos', 'atmosphere', 'space', 'metal', 'glitch', 'zap', 'laser', 'crackle', 'birds', 'insect', 'foley', 'ambient', 'drone', 'texture', 'reverse', 'coffee', 'water', 'rain', 'downlift', 'uplift', 'whoosh', 'boom', 'hit', 'siren', 'horn', 'scratch', 'drop', 'braam', 'buildup', 'build_up', 'stutter', 'swell', 'sfx'];
